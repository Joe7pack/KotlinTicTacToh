...
class StartGameTask {
    ...
    fun main(callerActivity: PlayersOnlineActivity, playerId: Int, playerName: String, opponentPlayerId: String, opponentPlayerName: String,resources: Resources) = runBlocking {
        val willyShmoApplicationContext = WillyShmoApplication.willyShmoApplicationContext
        mCallerActivity = callerActivity
        mResources = resources
        writeToLog("StartGameTask", "main() called at: " + SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(Date()))
